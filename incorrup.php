  ...
  <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 col-sm-12">
            <h1 class="mt-2">Les Incorruptibles</h1>
            <hr>
            <div class="row">
            ...
            <div class="row">
              <div class="offset-sm-1 col-sm-6 mt-2">
                ...
                <p>Un remake de la série est diffusé entre 1993 - 1994, créé par Christopher Crowe.</p>
                <hr>
                <h3>Résumé</h3>
        ...
        <div class="offset-sm-1">
          ...
          <figure>
            ...
            <audio
           controls
            src="http://prouvost.com/fun/generiques/--%20Series%20--/Les%20Incorruptibles.mp3" controlsList="nodownload">
